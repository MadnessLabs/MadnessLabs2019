...
export declare class MockAttr {
    ...
    constructor(attrName: string, attrValue?: string, namespaceURL?: string);
    name: string;
    value: string;
    nodeName: string;
    nodeValue: string;
...
export declare class MockDocumentFragment extends MockElement {
...
export declare function setupGlobal(global: any): any;
export declare function teardownGlobal(global: any): void;
