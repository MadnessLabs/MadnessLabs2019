...
class MockElement extends MockNode {
    constructor(ownerDocument, nodeName) {
        super(ownerDocument, 1 /* ELEMENT_NODE */, typeof nodeName === 'string' ? nodeName.toUpperCase() : null, null);
...
function setupGlobal(global) {
    if (global.window == null) {
        const win = global.window = new MockWindow();
...
export { MockAttr, MockAttributeMap, MockComment, MockCustomEvent, MockDocument, MockElement, MockKeyboardEvent, MockNode, MockTextNode, MockWindow, cloneAttributes, cloneDocument, cloneWindow, constrainTimeouts, createDocument, createFragment, parseHtmlToDocument, parseHtmlToFragment, resetDocument, resetWindow, serializeNodeToHtml, setupGlobal, teardownGlobal };
