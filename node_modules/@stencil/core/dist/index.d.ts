...
export { ComponentDidLoad, ComponentDidUnload, ComponentDidUpdate, ComponentWillLoad, ComponentWillUpdate, ComponentInstance as ComponentInterface, StencilConfig as Config, EventEmitter, FunctionalComponent, QueueApi, JSX } from './declarations';
/**
 * Build
 */
...
export declare namespace h {
    function h(sel: any): d.VNode;
    function h(sel: Node, data: d.VNodeData): d.VNode;
    function h(sel: any, data: d.VNodeData): d.VNode;
    function h(sel: any, text: string): d.VNode;
    function h(sel: any, children: Array<d.VNode | undefined | null>): d.VNode;
    function h(sel: any, data: d.VNodeData, text: string): d.VNode;
    function h(sel: any, data: d.VNodeData, children: Array<d.VNode | undefined | null>): d.VNode;
    function h(sel: any, data: d.VNodeData, children: d.VNode): d.VNode;
    namespace JSX {
