...
class ScreenshotLocalConnector extends ScreenshotConnector {
    async publishBuild(results) {
        ...
        const appSrcUrl = utils.normalizePath(path.relative(this.screenshotDir, compareAppSourceDir));
        const imagesUrl = utils.normalizePath(path.relative(this.screenshotDir, this.imagesDir));
        const jsonpUrl = utils.normalizePath(path.relative(this.screenshotDir, this.cacheDir));
