...
export class MlApps {
  ...
  apps = [
    ...
    },
    {
      ...
      text:
        "a pseudo-Latin text used in web design, typography, layout, and printing in place of English to emphasise design elements over content. Its also called placeholdertext. a convenient tool for mock-ups. It helps to outline the visual elements",
      background: "/assets/images/raf2/1E5B1781@2x.png",
